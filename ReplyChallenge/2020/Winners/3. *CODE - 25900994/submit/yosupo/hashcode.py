...
def main():
    ...
    hashcode.register_solution('../in/b.txt', 'optex/b2.txt')
    hashcode.register_solution('../in/d.txt', 'optex/d.txt')
    hashcode.register_solution('../in/e.txt', 'optex/e.txt')

    while True:
       result = hashcode.run_with_best('../in/b.txt', './assing_opt2.cpp')
